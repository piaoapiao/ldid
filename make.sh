...
if which xcrun &>/dev/null; then
    ...
    # for arch in i386 x86_64; do    // build i386 error
...
# -g flag suppor xcode debug
"${flags[@]}" -g -c -std=c++11 -o ldid2.o ldid2.cpp
"${flags[@]}" -g -o ldid2 ldid2.o -x c lookup2.c -x c sha1.c -x c sha224-256.c
